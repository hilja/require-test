 ...
 */
define('modules/dimensions',['jquery'], function($) {
    return {
 ...
 */
define('modules/media-queries',['jquery'], function($) {
    var getValues, bp;
...
define('modules/hider-shower',['jquery'], function($) {
    /**
 ...
 */
define('modules/app',['require','./dimensions','./classes','./sticky-position','./media-queries','jquery','./debounce','./hider-shower'],function(require) {
